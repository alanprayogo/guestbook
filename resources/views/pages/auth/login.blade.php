...
<body class="bg-gray-50 dark:bg-neutral-900">
    ...
    <!-- Content -->
    <div
        class="shadow-2xs mx-auto mt-7 w-full max-w-md rounded-xl border border-gray-200 bg-white px-4 sm:px-6 lg:px-8 dark:border-neutral-700 dark:bg-neutral-900">
