                    ...
                    <div class="inline-block min-w-full p-1.5 align-middle">
                        <div
                            ...
                            <div class="border-b border-gray-200 px-6 py-4 dark:border-neutral-700">
                                <div class="flex items-center gap-3"> <!-- Atur horizontal dan jarak -->
                                    <!-- Form Import Excel -->
                                    <form id="importForm" action="{{ route('importGuest') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <x-button variant="import-excel" id="triggerImportBtn">Import Excel</x-button>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                fileInput.addEventListener('change', function() {
                    if (fileInput.files.length > 0) {
                        form.submit(); // Submit form setelah file dipilih
                    }
                });
            });
        </script>
