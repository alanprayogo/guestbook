                        ...
                        <div
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <x-button href="{{ route('exportGuest') }}" variant="export-excel">Export Excel</x-button>
...
">
                                    ...
                                    <button type="button"
                                        class="inline-flex items-center justify-center flex-auto px-4 py-3 text-sm font-medium text-center text-gray-500 bg-transparent rounded-lg focus:outline-hidden gap-x-2 hover:text-blue-600 focus:text-blue-600 hs-tab-active:bg-blue-600 hs-tab-active:text-white dark:text-neutral-400 dark:hover:text-neutral-300"
...
"
                                ...
                                <div class="mt-3">
                                    <textarea id="text-pengantar" rows="15" name="kata_pengantar"
                                        class="w-full p-3 text-sm text-gray-700 border border-gray-300 rounded-lg dark:border-gray-600 dark:bg-gray-800 dark:text-white"></textarea>
                                </div>
                            </div>
    ...
    <div id="hs-static-backdrop-modal"
        ...
        <div
            ...
            <div
                class="flex flex-col bg-white border border-gray-200 shadow-lg pointer-events-auto rounded-xl dark:border-neutral-700 dark:bg-neutral-800">
                <!-- Header -->
                <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-neutral-700">
                    ...
                    <button type="button"
                        class="inline-flex items-center justify-center text-gray-600 bg-gray-100 border border-transparent rounded-full size-8 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:bg-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-600"
                ...
                <div class="p-4 overflow-y-auto">
                    <form method="POST" id="editGuestForm">
                        ...
                        <div class="p-2 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="guest_name" id="editGuestName" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white"
                            ...
                            <div>
                                ...
                                <select id="editGuestCategory" name="category_id"
                                    class="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white">
                        ...
                        <!-- Button Section -->
                        <div
                            class="flex items-center justify-end pt-4 mt-6 space-x-3 border-t border-gray-200 dark:border-neutral-700">
                            <button type="button" data-hs-overlay="#hs-static-backdrop-modal"
                                class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-600">
                                Batal
                            </button>
                            <button type="submit"
                                class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-700 dark:hover:bg-blue-800">
                                Simpan Perubahan
                            </button>
                        </div>
                    </form>
    ...
    <div id="arrival-confirm-modal"
        class="fixed top-0 left-0 hidden w-full h-full overflow-x-hidden overflow-y-auto transition-all opacity-0 hs-overlay z-100 bg-black/50 hs-overlay-open:scale-100 hs-overlay-open:opacity-100 hs-overlay-open:duration-500">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="w-full max-w-md p-6 transition-all bg-white rounded-lg shadow-lg dark:bg-neutral-800">
